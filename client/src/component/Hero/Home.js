        ...
        <div className="container f_flex top">
          <div className="left_top">
            ...
            <h2>
              ...
              <span>
                <Typewriter
                  words={[" Full Stack Devloper...", " Web Developer..."]}
                  loop
                  cursor
                  cursorStyle="|"
                  typeSpeed={70}
            ...
            <p id="para">
              To learn more, improve my knowledge & professional skills and
              contribute my best as proficient to the growth of the
              organization.My skills and experience in a more meaningful way I'm
              confident that switching to this new domain will enable me to grow
              professionally.{" "}
            </p>
